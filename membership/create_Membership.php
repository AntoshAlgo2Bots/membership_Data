            ...
            <div class="">
                <div class="flex flex-wrap gap-x-8 justify-center">
                    <fieldset class="w-1/6 border-2 border-gray-900 p-5 rounded-lg">
                        ...
                        <div>
                            <label for="email"
                                class="block  mb-1 font-bold text-xs font-medium text-gray-900 dark:text-white">Membership No :
                            </label>
                            <input type="text" name="membership_no" id="membership_number" disabled placeholder="Enter serial number"
                    ...
                    <fieldset class="w-4/6 border-2 border-gray-900 p-5 rounded-lg">
                        ...
                        <div class="flex flex-wrap justify-around">
                            ...
                            <div class="">
                                <label
                                    class="block w-60 mb-1 font-bold text-xs font-medium text-gray-900 dark:text-white">Start date: </label>
                        ...
                        <div class="flex flex-wrap justify-around">
                            ...
                            <div class="">
                                <label
                                    class="block w-60 mb-1 font-bold text-xs font-medium text-gray-900 dark:text-white">End  date :
                                    : </label>
                        ...
                        <div class="">
                                ...
                                <!-- <input type="txt" name="status" placeholder="Status"
                                    class="w-60 rounded-md h-8 border mb-3 text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" /> -->
                                    <select name="w-60 rounded-md h-8 border mb-3 text-xs border-gray-500 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" id="">
